...
INSERT INTO `books` VALUES (1,'Introduction to Algorithms','Gilbert, D.K.',5,5),(2,'Introduction to operations research','Gillett, B.E.',2,2),(3,'Magazine 2','Me',13,13),(4,'Magazine 1','Me',10,9),(5,'Test Book','Test Author',10,10),(6,'Test Book 2','Test Author2',11,11);
...
INSERT INTO `category` VALUES (1,'Library Management System'),(2,'Railway Reservation System'),(3,'Movie Ticket Booking System'),(4,'Flight Reservation System');
...
INSERT INTO `component` VALUES (1,1,'SearchComp.jsp','Search Books'),(2,1,'ShowBooksComp.jsp','Show Books'),(3,1,'IssueReturnComp.jsp','Issue/Return Books'),(4,1,'AddBookComp.jsp','Add Books to the Library System'),(5,1,'EditBookComp.jsp','Edit Books in the Library System'),(6,3,'SelectCityComp.jsp','Select city'),(7,2,'FTCityComp.jsp','Select from to city'),(8,2,'GetTrainsComp.jsp','Get trains'),(9,2,'SelectTrainNoComp.jsp','Select Train No.'),(10,2,'SelectDateComp.jsp','Select Boarding Date'),(11,2,'SelectClassComp.jsp','Select class of coach for boarding'),(12,2,'SelectPassengerComp.jsp','Select passengers'),(13,2,'GenerateBillComp.jsp','Generate bill'),(14,4,'FTCityComp.jsp','Select from to city'),(15,4,'GetFlightsComp.jsp','Get Flights'),(16,4,'SelectFlightNoComp.jsp','Select Flight No.'),(17,4,'SelectDateComp.jsp','Select Boarding date'),(18,4,'SelectClassComp.jsp','Select class'),(19,4,'SelectPassengerComp.jsp','Select Passenger'),(20,4,'GenerateBillComp.jsp','Generate Bill');
...
--
-- Table structure for table `flight_stations`
--

DROP TABLE IF EXISTS `flight_stations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `flight_stations` (
  `id` int(11) NOT NULL,
  `flight_id` varchar(20) NOT NULL,
  `station` varchar(45) NOT NULL,
  `station_no` int(11) NOT NULL,
  `arrival_time` varchar(45) NOT NULL,
  `dept_time` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `flight_stations`
--

LOCK TABLES `flight_stations` WRITE;
/*!40000 ALTER TABLE `flight_stations` DISABLE KEYS */;
/*!40000 ALTER TABLE `flight_stations` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `issue_logs` VALUES (13,1,'spydee','returned','2020-05-28 07:05:03','spydee','spydee'),(14,1,'spydee','returned','2020-05-28 07:05:03','spydee','spydee'),(15,2,'spydee','returned','2020-04-21 07:39:45','spydee','spydee'),(16,4,'spydee','returned','2020-04-21 17:33:21','spydee','spydee'),(17,3,'spydee','returned','2020-04-22 06:07:11','spydee','spydee'),(18,1,'spydee','returned','2020-05-28 07:05:03','spydee','spydee'),(19,4,'spydee','returned','2020-04-22 06:12:09','spydee','spydee'),(20,4,'spydee','returned','2020-04-22 06:19:25','spydee','spydee'),(21,4,'spydee','returned','2020-04-22 07:31:32','spydee','spydee'),(22,1,'spydee','returned','2020-05-28 07:05:03','admin','spydee'),(23,1,'spydee','returned','2020-05-28 07:05:03','spydee','spydee'),(24,5,'spydee','returned','2020-05-29 15:47:18','spydee','spydee');
...
INSERT INTO `reservations` VALUES (5,12417,'prayagraj','new delhi',1,'3rd ac','dummy_for_test',1,1980,'Prayag Raj Express','spydee','Spider Man'),(6,12417,'prayagraj','new delhi',1,'3rd ac','dummy_for_test',2,2970,'Prayag Raj Express','spydee','Spider Man'),(7,12417,'prayagraj','new delhi',1,'3rd ac','dummy_for_test',0,990,'Prayag Raj Express','spydee','Spider Man'),(8,12417,'prayagraj','new delhi',1,'3rd ac','dummy_for_test',0,990,'Prayag Raj Express','spydee','Spider Man'),(9,12417,'prayagraj','new delhi',1,'3rd ac','dummy_for_test',0,990,'Prayag Raj Express','spydee','Spider Man'),(10,12417,'prayagraj','new delhi',3,'3rd ac','Tue Oct 11 00:00:00 IST 35',0,2970,'Prayag Raj Express','spydee','Spider Man'),(11,12417,'prayagraj','new delhi',1,'sleeper','Tue Apr 04 00:00:00 IST 198',0,400,'Prayag Raj Express','spydee','Spider Man'),(12,12417,'prayagraj','new delhi',1,'3rd ac','2020-06-01',0,990,'Prayag Raj Express','spydee','Spider Man'),(13,12417,'prayagraj','new delhi',1,'3rd ac','10-60-0202',0,990,'Prayag Raj Express','spydee','Spider Man'),(14,12417,'prayagraj','new delhi',1,'3rd ac','Sat Dec 11 00:00:00 IST 6',0,990,'Prayag Raj Express','spydee','Spider Man'),(15,12417,'prayagraj','new delhi',1,'3rd ac','11-12-0006',0,990,'Prayag Raj Express','spydee','Spider Man'),(16,12417,'prayagraj','new delhi',1,'3rd ac','11-12-0006',0,990,'Prayag Raj Express','spydee','Spider Man'),(17,12417,'prayagraj','new delhi',1,'3rd ac','2020-06-01',0,990,'Prayag Raj Express','spydee','Spider Man'),(18,12417,'prayagraj','new delhi',1,'3rd ac','2020-06-01',0,990,'Prayag Raj Express','spydee','Spider Man'),(19,12417,'prayagraj','new delhi',1,'sleeper','2020-04-27',0,400,'Prayag Raj Express','spydee','Spider Man'),(20,12417,'prayagraj','new delhi',2,'sleeper','2020-05-01',0,800,'Prayag Raj Express','spydee','Spider Man'),(21,12417,'prayagraj','ghaziabad',1,'3rd ac','2020-04-23',0,800,'Prayag Raj Express','spydee','Spider Man'),(22,12417,'prayagraj','new delhi',5,'3rd ac','2020-04-30',0,4950,'Prayag Raj Express','spydee','Spider Man'),(23,12417,'prayagraj','new delhi',1,'sleeper','2020-05-06',0,400,'Prayag Raj Express','spydee','Spider Man'),(24,12417,'prayagraj','new delhi',1,'3rd ac','2020-05-21',0,990,'Prayag Raj Express','spydee','Spider Man'),(25,12417,'prayagraj','new delhi',1,'3rd ac','2020-05-13',0,990,'Prayag Raj Express','spydee','Spider Man'),(26,10101,'prayagraj','new delhi',1,'1st ac','2020-05-15',0,-1,'dummy','spydee','Spider Man'),(27,12417,'prayagraj','new delhi',1,'3rd ac','2020-05-29',0,990,'Prayag Raj Express','spydee','Spider Man'),(28,12417,'prayagraj','new delhi',1,'3rd ac','2020-05-29',0,990,'Prayag Raj Express','spydee','Spider Man');
...
-- Dump completed on 2020-07-08 21:13:52
